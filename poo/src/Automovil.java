...
public class Automovil implements Comparable<Automovil> {
    ...
    public Automovil(String fabricante, String modelo, Color color, Motor motor, Estanque estanque, Rueda[] ruedas, Persona conductor) {
    ...
    public int compareTo(Automovil a) {
        return this.modelo.toString().compareTo(a.modelo.toString());
    }
}
